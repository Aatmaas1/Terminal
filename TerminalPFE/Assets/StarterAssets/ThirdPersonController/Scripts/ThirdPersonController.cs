...
namespace StarterAssets
{
    ...
    public class ThirdPersonController : MonoBehaviour
    {
        #region Variables
        [Header("Player")]
        [Tooltip("Is jumping enabled ?")]
        public bool canJump = false;
        [Tooltip("Is running enabled ?")]
        public bool canRun = false;
        [Tooltip("Is the FOV changing when running ?")]
        public bool zoomies = false;
        [Tooltip("Value of FOV Distortion with Zoomies")]
        public float ZoomiesValue = 0.025f;
        ...
        [Tooltip("This changes how much time you have to jump after leaving the ground")]
        public int MaxCoyoteTime = 3;
        ...
        [Tooltip("Changes the speed of the camera")]
        ...
        private void CameraRotation()
        {
            if (GetComponent<PlayerInput>().currentActionMap.name == "Player")
            {
                ...
                if (_input.look.sqrMagnitude >= _threshold && !LockCameraPosition)
                {
                    ...
                    _cinemachineTargetYaw += _input.look.x * deltaTimeMultiplier * CameraSpeed;
                    _cinemachineTargetPitch += _input.look.y * deltaTimeMultiplier * CameraSpeed;
                }
        ...
        private void Move()
        {
            ...
            if (zoomies)
            {
                VirtualCamera.m_Lens.FieldOfView = Mathf.Lerp(VirtualCamera.m_Lens.FieldOfView, 40 + currentHorizontalSpeed * 2, ZoomiesValue);
            }
